...
//!
FriendMapSettings::FriendMapSettings() : geoip_data_path(""), map_theme_id("earth/bluemarble/bluemarble.dgml") {
...
void FriendMapSettings::processSettings(bool load) {
    ...
    if (load) {
        ...
        projection = static_cast<Marble::Projection>(Settings->value("projection_type").toInt());
